...
function run_renaming(canvas)
{
const ISSUE_X = 110
const ISSUE_Y = 50;
const MEMORY_X = ISSUE_X + 120;
const MEMORY_Y = ISSUE_Y;
const ALU_X = MEMORY_X;
const ALU_Y = MEMORY_Y + 60;
const REGISTER_X = MEMORY_X+3*90 + 70;
const REGISTER_Y = MEMORY_Y - 40;
const CODE_X = 15;
const CODE_Y = ISSUE_Y + 130 + 0;
const STATUS_X = 230
const STATUS_Y = 220
const BUTTON_Y = 300;
...
const rwcol = [[col2, col2, col2, col2, col0, col0, col0, col0],
               [col2, col0, col2, col2, col1, col0, col0, col0],
               [col2, col0, col2, col2, col3, col1, col0, col0],
               [col0, col0, col2, col2, col3, col2, col1, col0],
               [col0, col0, col0, col2, col0, col2, col2, col1],
               [col0, col0, col0, col2, col0, col2, col2, col1],
               [col0, col0, col0, col2, col0, col2, col2, col1],
               [col0, col0, col0, col2, col0, col2, col2, col2],
               [col0, col0, col0, col2, col0, col2, col2, col2]];
...
ctx.clearRect(CODE_X, CODE_Y, 200, 160);
//ctx.strokeRect(CODE_X, CODE_Y, 200, 160);
...
function draw_issue(x, y)
{

ctx.clearRect(x-15, y-2, 110, 124);
//ctx.strokeRect(x-15, y-2, 110, 124);
...
for (i = 0; i < 4; i++)
  ...
  ctx.fillRect(x + 30, y + 10 + i * 20, 40, 20);
  ctx.strokeRect(x + 30, y + 10 + i * 20, 40, 20);

  ctx.fillStyle = "Black";
  ctx.fillText(R[i], x + 15, y + 10 + i * 20 + 16);
  ctx.fillText(reg[step][i], x + 50, y + 10 + i * 20 + 16);
  }

ctx.fillStyle = "Black";
/*
  ctx.fillText(9, x-10, y + i * 20 + 16);
  ctx.fillText("R?", x+20, y + i * 20 + 16);
*/
ctx.fillText("Instruction issue", x+40, y + 100 + 16);
...
if (mem0[step][0].charAt(0) == 'N') ctx.fillStyle = "Gold";
else              ctx.fillStyle = col0;
...
if (mem0[step][1].charAt(0) == 'N') ctx.fillStyle = "Gold";
else              ctx.fillStyle = col0;
...
if (mem0[step][2].charAt(0) == 'N') ctx.fillStyle = "Gold";
else              ctx.fillStyle = col0;
...
if (alu0[step].charAt(0) == 'N') ctx.fillStyle = "Gold";
else                             ctx.fillStyle = col0;
...
ctx.clearRect(REGISTER_X-5, REGISTER_Y-2, 90, 204);
//ctx.strokeRect(REGISTER_X-5, REGISTER_Y-2, 90, 204);

ctx.save();

ctx.strokeStyle = "Black";
ctx.fillStyle = BACK;
ctx.fillRect(REGISTER_X, REGISTER_Y, 80, 180);
ctx.strokeRect(REGISTER_X, REGISTER_Y, 80, 180);
...
switch (step)
  ...
  case 1: str = "Load in address calculation stage.  R1 is remapped to N4."; break;
  case 2: str = "Load address output; move overtaking through ALU. N4 superseded."; break;
  case 3: str = "Data returned from memory; move in ALU gets R1 (N5) forwarded."; break;
  case 4: str = "Two more results reach register file."; break;
  case 5: str = "Second load proceeds through memory pipe."; break;
  case 6: str = "Second load data returned."; break;
  case 7: str = "Load result stored.  Note ealier register values not overwritten."; break;
